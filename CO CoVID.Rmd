...
names(COdataRWJ2020) <- paste(names(COdataRWJ2020), COdataRWJ2020[1, ], sep = "_")
names(COdataRWJ2020) = gsub(" ", ".", names(COdataRWJ2020))
names(COdataRWJ2020) = gsub("-", "_", names(COdataRWJ2020))
#MetricsCO = unique(colnames(COdataRWJ2020))
COdataRWJ2020 = COdataRWJ2020[-1,]
COdataRWJ2020 = COdataRWJ2020[,-1]
COdataRWJ2020 = COdataRWJ2020[,-1]
names(COdataRWJ2020) = gsub("X.1_County", "COUNTY", names(COdataRWJ2020))
#unique(colnames(COdataRWJ2020))
COdataRWJ2020 = COdataRWJ2020 %>% mutate_at(., "COUNTY", toupper)
COdataRWJ2020 = COdataRWJ2020 %>% mutate_if(., !str_detect(colnames(.), "COUNTY"), as.numeric)
