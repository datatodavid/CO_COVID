...
## COVID DATASET #3 STATE & COUNTY DAILY LEVEL ##
...
COVID19State_MERGE = COVID19StateData %>% 
  select(., COUNTY, Date, POP, COVID.Tests.Per.100000, COVID.Cases.Per.100000, COVID.Deaths.Per.100000, COVID.Mortality.Perc)
...
COVID19County_MERGE = COVID19County %>% 
  ...
  select(., COUNTY, Date, POP, COVID.Tests.Per.100000 = Testing.Rates.Per.100000, COVID.Cases.Per.100000 = Case.Rates.Per.100000, COVID.Deaths.Per.100000, COVID.Mortality.Perc)
...
CO_MORTALITY_MORBIDITY = CO_COUNTY_COVID_SIMPLEST %>% 
  select(., COUNTY, 
         ...
         starts_with("Life.Expectancy.2010"), contains("YPLL"),
...
CO_SUMMARY_SCORES = CO_COUNTY_COVID_SIMPLEST  %>% select(., COUNTY, 
  COVID.Tests.Per.100000, COVID.Cases.Per.100000,  
  COVID.Deaths.Per.100000, COVID.Mortality.Perc,
  YPLL.Years.of.Potential.Life.Lost.Rate, Life.Expectancy.2010.2015.Rate,
...
CO_MORTALITY_MORBIDITY_FULL = CO_COUNTY_COVID_FILTER %>% select(., COUNTY, 
   COVID.Tests.Per.100000, COVID.Cases.Per.100000,  
   COVID.Deaths.Per.100000, COVID.Mortality.Perc,
   starts_with("Life.Expectancy.2010"), contains("YPLL"), contains("Hospitalizations"),
...
#   factor(COVID19ALL_MERGE$COUNTY,
...
#          "HUERFANO","JACKSON","JEFFERSON","KIOWA","KIT CARSON","LA PLATA","LAKE","LARIMER",
#          "LAS ANIMAS","LINCOLN","LOGAN","MESA","MINERAL","MOFFAT","MONTEZUMA","MONTROSE",
#          "MORGAN","OTERO","OURAY","PARK","PHILLIPS","PITKIN","PROWERS","PUEBLO","RIO BLANCO",
